...
export default function NotificationListPage() {
  ...
  const fetchData = async () => {
    try {
      // Récupère toutes les notifs pour les stats
      ...
      // Récupère la page courante avec filtres
  ...
  return (
    <div style={{ padding: "24px 20px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
        ...
        <button style={btnAdd} onClick={() => window.location.href = "/notifications/new"}>
          ...
          {notifications.map((n) => (
            <tr
              ...
              style={{
                ...
                background: n.statut === "NON_LUE" ? "#eff6ff" : "white",
                cursor: "pointer",
              }}
              onClick={() => window.location.href = `/notifications/${n.id}`}
            >
              ...
              <td style={tdStyle}>
                <span style={{
                  background: STATUT_COLORS[n.statut!] + "22",
              ...
              <td style={tdStyle}>
                <button style={btnView} onClick={(e) => { e.stopPropagation(); window.location.href = `/notifications/${n.id}`; }}>👁️</button>
                {n.statut === "NON_LUE" && (
